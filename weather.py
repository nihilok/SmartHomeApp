...
def api_call():
    data = requests.get('https://api.openweathermap.org/data/2.5/onecall?lat=51.6862&lon=-1.4129&exclude=minutely,hourly&units=metric&appid=7a5de2143958fd562561c73ddcfb8ced')
    return data.text
